# Mandrel Tools Reference Guide

**Post TT009 Tool Consolidation - 47 Tools Total**
*Last Updated: 2025-09-20*

This guide documents all 47 Mandrel MCP tools available after the successful TT009 consolidation project. Each tool has been tested and validated for functionality.

## 🎯 Quick Start

1. **Test Connection**: `mandrel_ping` - Always start here
2. **Explore Tools**: `mandrel_help` - See all available tools
3. **Get Help**: `mandrel_explain <tool_name>` - Detailed tool documentation
...
### `mandrel_ping`
**Purpose**: Test Mandrel server connectivity and health
**Usage**: `mandrel_ping(message?: string)`
**Status**: ✅ **WORKING**
```
Example: mandrel_ping()
Returns: "🏓 Mandrel Pong! Message: "Hello Mandrel!" | Time: 2025-09-21T02:33:55.602Z | Status: Operational"
```

### `mandrel_status`
**Purpose**: Get comprehensive server status and health information
**Usage**: `mandrel_status()`
**Status**: ✅ **WORKING**
```
...
1. System: `mandrel_ping`, `mandrel_status`
