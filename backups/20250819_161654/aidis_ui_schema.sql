...
CREATE TABLE public.contexts (
    ...
    CONSTRAINT contexts_context_type_check CHECK (((context_type)::text = ANY (ARRAY[('code'::character varying)::text, ('decision'::character varying)::text, ('error'::character varying)::text, ('discussion'::character varying)::text, ('planning'::character varying)::text, ('completion'::character varying)::text]))),
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: ridgetop
--
...
ALTER TABLE public.users OWNER TO ridgetop;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: ridgetop
--
...
ALTER SEQUENCE public.users_id_seq OWNER TO ridgetop;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ridgetop
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: ridgetop
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: ridgetop
--
...
--
-- Name: users users_username_key; Type: CONSTRAINT; Schema: public; Owner: ridgetop
--
