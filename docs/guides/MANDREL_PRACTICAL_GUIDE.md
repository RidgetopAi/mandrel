# 🎯 Mandrel Practical Usage Guide
## What We Actually Built & How to Use It

### 🎯 **THE PROBLEM Mandrel SOLVES**
...
**Mandrel = Persistent Memory + Coordination for Multi-Session AI Development**
...
Just use Mandrel for memory/consistency + regular Task tool for sub-agents
- Mandrel = Memory layer (context, naming, decisions)
...
**You know Mandrel is working when:**
